...
`;function je(e,t){let n=t,r=t-1;if(r>=0&&e[r].trim().endsWith(`*/`)){for(;r>=0&&!e[r].trim().startsWith(`/*`);)--r;r>=0&&(n=r)}else for(;r>=0&&e[r].trim().startsWith(`//`);)n=r,--r;return n}function Me(e,t){let n=e.split(`
`),r=RegExp(`^\\s*(?:export\\s+)?(?:async\\s+)?(?:function|const|type|class)\\s+${t}\\b`),i=n.findIndex(e=>r.test(e));if(i===-1)return null;let a=je(n,i),o=0,s=!1;for(let e=i;e<n.length;e+=1){for(let t of n[e])t===`{`||t===`(`||t===`[`?(o+=1,s=!0):(t===`}`||t===`)`||t===`]`)&&--o;if(!s&&n[e].trimEnd().endsWith(`;`)||s&&o<=0)return n.slice(a,e+1).join(`
`)}return null}function H(e,t,n){return t.map(t=>Me(e,t)??`// ⚠ 在 ${n} 中找不到 ${t}，可能已改名`).join(`

`)}function Ne(e){let t=[];return e.rawInput.trim()?e.parsedJson||t.push({code:`not-json`,message:`這份內容不是可解析的 JSON。`,howToFix:`這條流程需要結構化欄位（R／PR／CKD／檢驗紀錄）才能判定主題與門檻，純文字無法使用。請改上傳原始 JSON。`,hard:!0}):t.push({code:`no-input`,message:`還沒有病人資料。`,howToFix:`上傳健保申報 JSON、貼上 JSON 內容，或按「載入去識別示範」。`,hard:!0}),e.model.trim()||t.push({code:`no-model`,message:`沒有選擇模型。`,howToFix:`在下方選一個模型，或填入自訂模型 ID。`,hard:!0}),e.requiresClientKey&&!e.apiKey.trim()&&t.push({code:`no-key`,message:`這個版本需要在頁面輸入 Gemini API 金鑰。`,howToFix:`在下方貼上金鑰。金鑰只留在這一頁的記憶體，重新整理即清除。`,hard:!0}),e.totalTokens>e.tokenLimit&&t.push({code:`over-limit`,message:`輸入約 ${e.totalTokens.toLocaleString(`zh-TW`)} tokens，超過模型上限 ${e.tokenLimit.toLocaleString(`zh-TW`)}。`,howToFix:`本工具不會自動截斷病人資料。請改用可接受更長輸入的模型，或減少送入的紀錄。`,hard:!0}),t}function Pe(e){return e.some(e=>e.hard)}function Fe(e,t,n){let r=n??{tokens:Te(t),method:`estimate`};return{label:e,chars:P(t),tokens:r.tokens,method:r.method}}function Ie(e){let t=[{label:`① 資料稽核：system prompt`,text:e.selectorPrompt},{label:`① 資料稽核：病人事實摘要`,text:e.factsText},{label:`② 檢驗判讀：system prompt`,text:e.labReviewPrompt},{label:`② 檢驗判讀：檢驗紀錄`,text:e.labText},{label:`③ 檢驗敘述：system prompt`,text:e.narrativePrompt},{label:`③ 檢驗敘述：檢驗紀錄與缺檢清單`,text:e.narrativeText}],n=t.map(e=>Fe(e.label,e.text));return{text:t.map(e=>e.text).join(`

`),systemPrompt:e.selectorPrompt,parts:n,totalChars:n.reduce((e,t)=>e+t.chars,0),totalTokens:n.reduce((e,t)=>e+t.tokens,0)}}var Le=[`REPORT_DATE`,`BIRTHDAY`,`INDX_DATE`,`SEX`,`P4P`,`HT`,`HL`,`CKD`,`T`,`DCSI`,`AGEGP`,`GRADE`],Re={REPORT_DATE:`報告日期`,BIRTHDAY:`出生日期`,INDX_DATE:`糖尿病指標日期`,SEX:`性別代碼`,P4P:`是否參加糖尿病P4P`,HT:`高血壓`,HL:`高血脂`,CKD:`慢性腎臟病`,T:`糖尿病病程年數`,DCSI:`DCSI總分`,AGEGP:`年齡分組`,GRADE:`整體分級`},ze={medication:`用藥紀錄`,labData:`檢驗資料`,chinesemed:`中藥用藥`,imaging:`影像資料`,allergy:`過敏資料`,surgery:`手術資料`,discharge:`出院資料`,medDays:`用藥天數資料`,patientSummary:`病人摘要`,cancerScreening:`癌症篩檢`,adultHealthCheck:`成人健檢`},Be=new Set([`drug_code`,`drug_ing_code`,`func_seq_no`,`fee_ym`,`drug_multi_mark`,`drug_std_qty`,`assay_method`]);function U(e){return!!e&&typeof e==`object`&&!Array.isArray(e)}function W(e){return e==null||e===``||e===`null`?`未提供`:typeof e==`object`?JSON.stringify(e):String(e).replaceAll(`\r`,` `).replaceAll(`
`,` `).trim()||`未提供`}function G(e){return Array.isArray(e)?e.map(G):U(e)?Object.fromEntries(Object.keys(e).sort().map(t=>[t,G(e[t])])):e}function Ve(e){let t=new Map;for(let n of e){let e=JSON.stringify(G(n)),r=t.get(e);r?r.count+=1:t.set(e,{record:n,count:1})}return[...t.values()]}function He(e,t){let n=Le.indexOf(e),r=Le.indexOf(t);if(n!==-1||r!==-1)return n===-1?1:r===-1?-1:n-r;let i=e.match(/^(R|PR)(\d+)$/),a=t.match(/^(R|PR)(\d+)$/);return i&&a?i[1]===a[1]?Number(i[2])-Number(a[2]):i[1]===`R`?-1:1:i?-1:a?1:e.localeCompare(t)}function Ue(e,t=0){let n=`  `.repeat(t);if(Array.isArray(e))return e.length?e.flatMap((e,r)=>U(e)||Array.isArray(e)?[`${n}- 第 ${r+1} 筆`,...Ue(e,t+1)]:[`${n}- ${W(e)}`]):[`${n}（空陣列）`];if(U(e)){let r=Object.entries(e);return r.length?r.flatMap(([e,r])=>U(r)||Array.isArray(r)?[`${n}${e}：`,...Ue(r,t+1)]:[`${n}${e}：${W(r)}`]):[`${n}（空物件）`]}return[`${n}${W(e)}`]}function We(e,t){let n=e[t];return U(n)&&Array.isArray(n.rObject)?n.rObject:[]}function Ge(e){return U(e)?Object.entries(e).filter(([,e])=>e!=null&&e!==``&&e!==`null`).map(([e,t])=>`${e}:${W(t)}`).join(`｜`):W(e)}function Ke(e,t={}){let n=t.skipIrrelevantLabs??!0;if(!U(e))return[`【輸入資料】`,...Ue(e),``,`【資料使用限制】`,`以上僅重新排版，沒有推定缺少的診斷、日期、用藥狀態或治療資訊。`].join(`
`);if(![`downloadType`,`userInfo`,`userInput`,`rawSources`].some(t=>t in e))return[`【來源JSON欄位】`,...Ue(e),``,`【資料使用限制】`,`以上保留來源欄位並重新排版；空值或未出現欄位不得自行解讀為0或正常。`].join(`
`);let r=[`【檔案與基本資料】`,`資料匯出類型：${W(e.downloadType)}`],i=U(e.userInfo)?e.userInfo:{},a=U(e.userInput)?e.userInput:{},o=U(e.rawSources)?e.rawSources:{};for(let[e,t]of Object.entries(i))r.push(`${e}：${W(t)}`);r.push(``,`【來源模型欄位】`,`以下保留來源原值；未提供不等同於0。`);let s=Object.keys(a).sort(He);s.length||r.push(`未提供來源模型欄位。`);for(let e of s){let t=Re[e]?`（${Re[e]}）`:``;r.push(`${e}${t}：${W(a[e])}`)}r.push(``,`【DCSI與風險欄位說明】`),r.push(`僅保留來源DCSI、R與PR原始欄位；整理階段不重新解釋分數。來源未出現的欄位不得自行補值，也不得直接視為0。`),r.push(``,`【資料來源概況】`);let c=Object.entries(o);c.length||r.push(`未提供rawSources資料來源。`);for(let[e,t]of c){let n=U(t)&&Array.isArray(t.rObject)?t.rObject:[];r.push(`${ze[e]??e}（${e}）：${n.length}筆${n.length?``:`，來源為空陣列`}`)}let l=We(o,`medication`),u=Ve(l),d=new Map;for(let e of u){let t=U(e.record)?e.record:{},n=`${W(t.drug_date).replaceAll(`/`,`-`)}｜${`ICD ${W(t.icd_code)}｜${W(t.icd_cname)}`}`,r=Ge(Object.fromEntries(Object.entries(t).filter(([e])=>![`drug_date`,`icd_code`,`icd_cname`,`drug_ename`].includes(e)&&!Be.has(e)))),i=d.get(n)??[];i.push({text:r||`原紀錄沒有其他欄位`,count:e.count}),d.set(n,i)}r.push(``,`【用藥紀錄】`),r.push(`來源共${l.length}筆；完全相同紀錄合併後${u.length}筆。重複次數以×N保留；不同欄位不合併。`),l.length||r.push(`未提供用藥紀錄。`);for(let e of[...d.keys()].sort().reverse()){r.push(e);for(let t of d.get(e)??[])r.push(`- ${t.text}${t.count>1?`｜×${t.count}`:``}`)}let f=/^(13007C|13023C|13006C|11002C)$/,p=[/^(p?H|pH值)$/i,/^(PO2|pO2|PCO2|pCO2|HCO3|TCO2|O2SAT|BE|BEecf|BEb|SBC|ctO2|FIO2|A-?aDO2)/i,/(lymphocyte|monocyte|basophil|eosinophil|neutrophil|^ANC$|^Meta$|^Blast$|^Band|myelocyte|atypical|^Promye)/i,/(^hs)?CRP|procalcitonin|^ESR$|紅血球沉降/i,/^(PT|aPTT|APTT|INR)$|凝血|fibrinogen|D-?dimer/i];function m(e){if(f.test(String(e.order_code??``).trim()))return!0;let t=String(e.assay_item_name??``).trim();return p.some(e=>e.test(t))}let h=We(o,`labData`),g=Ve(h),_=new Map,v=0;for(let e of g){let t=U(e.record)?e.record:{};if(n&&m(t)){v+=e.count;continue}let r=[W(t.fee_ym),W(t.order_code),W(t.order_name),`檢體或模式:${W(t.inspect_mode)}`].join(`｜`),i=`${W(t.assay_item_name)}=${W(t.assay_value)}`;W(t.unit_data)!==`未提供`&&(i+=` ${W(t.unit_data)}`),i+=`｜參考:${W(t.consult_value)}`;let a=Object.entries(t).filter(([e,t])=>![`fee_ym`,`order_code`,`order_name`,`assay_method`,`inspect_mode`,`assay_item_name`,`assay_value`,`unit_data`,`consult_value`].includes(e)&&!Be.has(e)&&t!=null&&t!==``).map(([e,t])=>`${e}:${W(t)}`);a.length&&(i+=`｜其他欄位:${a.join(`、`)}`);let o=_.get(r)??[];o.push({text:i,count:e.count}),_.set(r,o)}r.push(``,`【檢驗與檢查紀錄】`),r.push(`來源共${h.length}筆；完全相同紀錄合併後${g.length}筆。`+(v?`其中${v}筆與糖尿病長期照護無關（微生物培養、藥敏、輸血配合、血液氣體、白血球分類、發炎與凝血指標），未列於下方。`:``)+`若來源只有費用年月而沒有採檢日時，不得推定同月份內的先後順序。`),h.length||r.push(`未提供檢驗與檢查紀錄。`);for(let e of[..._.keys()].sort().reverse()){r.push(e);for(let t of _.get(e)??[])r.push(`- ${t.text}${t.count>1?`｜×${t.count}`:``}`)}r.push(``,`【其他來源的非空紀錄】`);let y=0;for(let[e]of c.filter(([e])=>![`medication`,`labData`].includes(e))){let t=We(o,e);if(!t.length)continue;y+=t.length;let n=Ve(t);r.push(`${ze[e]??e}（${e}）：來源${t.length}筆，完全相同紀錄合併後${n.length}筆。`),n.forEach((e,t)=>{r.push(`- ${t+1}. ${Ge(e.record)}${e.count>1?`｜×${e.count}`:``}`)})}y||r.push(`其餘來源目前沒有可列出的紀錄。`);let b=Object.keys(e).filter(e=>![`downloadType`,`userInfo`,`userInput`,`rawSources`].includes(e));if(b.length){r.push(``,`【其他根層欄位】`);for(let t of b)r.push(`${t}：${W(e[t])}`)}return r.push(``,`【資料使用限制】`),r.push(`以上為來源JSON重新排版；除合併完全相同紀錄外，未刪除不同結果，也未判定哪一筆較可信。重複筆數均以×N保留。`),r.push(`不同檢驗數值可能代表真實病程變化，也可能涉及資料品質；若有疑義，應由醫療人員結合實際採檢時間與臨床狀況確認。`),r.push(`來源未提供的日期、糖尿病類型、診斷、檢驗、用藥狀態或治療資訊不得自行補寫；歷史申報用藥不得直接描述為目前仍在使用。`),r.join(`
`)}var qe=300;function Je(e,t=qe){let n=e.replace(/\s+/g,` `).trim();return n.length<=t?n:`${n.slice(0,t)}…（原始回應共 ${n.length} 字，此處僅顯示前 ${t} 字）`}function Ye(e,t){let n=t.toLowerCase();return e===429||e>=500?!0:e===400&&(n.includes(`api key not valid`)||n.includes(`api_key_invalid`))?!1:!!(e===400&&(n.includes(`invalid argument`)||n.includes(`invalid_request`)))}function Xe(e,t){let n=t.toLowerCase();return e===400&&(n.includes(`api key not valid`)||n.includes(`api_key_invalid`))?{title:`Gemini 不接受這把 API 金鑰（HTTP 400）`,advice:`請確認貼上的是完整、未過期的金鑰，且該金鑰已啟用 Generative Language API。重新貼一次時注意不要含到前後空白。`}:e===400?{title:`Gemini 認為這次請求的內容或參數有問題（HTTP 400）`,advice:`常見原因是模型 ID 不支援目前的請求格式，或輸入內容含有無法處理的欄位。請對照下方原始錯誤，先試著改用預設模型。`}:e===401||e===403?{title:`這把金鑰沒有呼叫此模型的權限（HTTP `+e+`）`,advice:`請確認金鑰所屬專案已啟用 Generative Language API、未被限制來源網域，且帳單設定允許使用這個模型。`}:e===404?{title:`找不到這個模型 ID（HTTP 404）`,advice:`請確認模型名稱拼寫正確且你的金鑰有權存取。可先切回預設的 gemini-3.6-flash 確認流程本身正常。`}:e===413?{title:`請求內容過大，被拒絕（HTTP 413）`,advice:`檢驗紀錄很多的病人，②③ 兩次呼叫的輸入會很大。本工具不會自動截斷病人資料，需要縮減請由你決定，或改用可接受更長輸入的模型。`}:e===429?{title:`超過配額或速率上限（HTTP 429）`,advice:`每產出一份報告會送出三次呼叫，免費層級的額度用得很快。下方原文會寫明是哪一項配額、上限多少、建議多久後重試。請等額度恢復、改用其他模型，或換一把有額度的金鑰。`}:e===408||e===504||e===524||e===522?{title:`請求逾時（HTTP ${e}）`,advice:`檢驗紀錄多的病人，單次回應可能需要數分鐘，中間的代理層可能先行斷線。可延長逾時上限，或改用回應較快的模型。`}:e===499?{title:`連線在回應完成前被中斷（HTTP 499）`,advice:`多半是瀏覽器或中間代理層提前關閉連線。若發生在輸入很大的病人身上，請比照逾時處理。`}:e>=500?{title:`Gemini 端暫時性錯誤（HTTP ${e}）`,advice:`這不是你的輸入造成的。請稍候重試；若持續發生，改用另一個模型或稍後再跑。`}:{title:`Gemini 回傳 HTTP ${e}`,advice:`請參考下方原始錯誤內容判斷原因。`}}function Ze(e){let t=e.trim();return t&&t.toLowerCase()!==`unknown`?t:``}function K(e){let{status:t=null,apiMessage:n=``,rawBody:r=``,cause:i,timedOut:a=!1}=e,o=Ze(e.statusText??``);if(i instanceof Error&&i.name===`AbortError`&&!a)return{title:`已依你的要求停止這次請求`,advice:`沒有送出任何後續請求；你可以調整設定後重新執行。`,raw:``,status:null,aborted:!0,timedOut:!1,retryable:!1};if(a||i instanceof Error&&i.name===`TimeoutError`)return{title:`等待 Gemini 回應超過設定的時間上限`,advice:`檢驗紀錄多的病人回應時間會明顯拉長。可以延長逾時上限，或改用較快的模型。請求已中止，沒有部分結果。`,raw:i instanceof Error?i.message:``,status:null,aborted:!1,timedOut:!0,retryable:!1};if(i instanceof TypeError)return{title:`瀏覽器無法送出這次請求（網路層失敗）`,advice:`常見原因：網路中斷、瀏覽器擴充功能或企業代理封鎖了對 Gemini 的請求、或 CORS 被擋。請開瀏覽器主控台看是否有被封鎖的紀錄，並試著關閉擴充功能後重試。`,raw:i.message,status:null,aborted:!1,timedOut:!1,retryable:!1};if(t===null)return{title:`請求失敗`,advice:`請參考下方原始錯誤內容。`,raw:i instanceof Error?i.message:String(i??``),status:null,aborted:!1,timedOut:!1,retryable:!1};if(!n&&r){let e=/^\s*<(?:!doctype|html)/i.test(r),n=Xe(t,r);return{title:e?`回應不是 Gemini 的 JSON，而是一頁 HTML（HTTP ${t}${o?` ${o}`:``}）`:n.title,advice:e?`這代表請求沒有走到 Gemini，或在中途被代理層攔下並改回錯誤頁。${n.advice}`:n.advice,raw:Je(r),status:t,aborted:!1,timedOut:!1,retryable:Ye(t,r)}}let s=Xe(t,n);return{title:s.title,advice:s.advice,raw:n?Je(n):``,status:t,aborted:!1,timedOut:!1,retryable:Ye(t,n)}}var Qe=`https://generativelanguage.googleapis.com/v1/interactions`;function q(e){return!!e&&typeof e==`object`&&!Array.isArray(e)}async function $e(e){let t=await e.text(),n=null;try{let e=JSON.parse(t);q(e)&&(n=e)}catch{n=null}return{ok:e.ok,status:e.status,statusText:e.statusText,json:n,rawBody:t}}function et(e){return typeof e.output_text==`string`?e.output_text:typeof e.outputText==`string`?e.outputText:[...Array.isArray(e.steps)?e.steps:[]].reverse().flatMap(e=>!q(e)||e.type!==`model_output`||!Array.isArray(e.content)?[]:e.content).filter(e=>q(e)&&e.type===`text`&&typeof e.text==`string`).map(e=>String(e.text)).join(`
