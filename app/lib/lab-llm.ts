...
- 不得推測診斷，不得提出處置建議。「提示某某病」「符合某某表現」「反映某某受損」都算推測診斷。
  ...
  "abnormal": [
    {
      ...
      "worst_other": "另一個方向的極值，沒有就填空字串。高低兩端都有不代表數值在波動——不同筆之間沒有先後可言",
      "unit": "單位，沒有就填空字串",
      "reference": "該筆的參考值原文",
      "direction": "high | low | both",
      "why": "為什麼判為異常：只講它偏離參考值的哪一側與幅度。不要寫這代表什麼病、什麼機轉或什麼病程，30 字以內"
    }
  ],
  "groups": [
    { "system": "系統名稱", "items": ["項目名稱"], "pattern": "一句話說明這幾項共同落在哪個器官系統，以及與糖尿病照護的關聯。只描述它們併存，不要寫成病程、進展、惡化或波動，也不要下診斷" }
  ],
